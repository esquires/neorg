...
--- @tparam config table #A table that reflects the structure of configuration.user_configuration
...
--- @tparam manual boolean #If true then the environment was kickstarted manually by the user
