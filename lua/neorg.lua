...
--- @tparam table config A table that reflects the structure of configuration.user_configuration
...
--- @tparam boolean manual If true then the environment was kickstarted manually by the user
