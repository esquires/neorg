...
--- @tparam string type The full path of a module event
...
--- @tparam table module A reference to the module invoking the function
--- @tparam string type A full path to a valid event type (e.g. 'core.module.events.some_event')
...
--- @tparam table module A reference to the module invoking the function
--- @tparam string name A relative path to a valid event template
...
--- @tparam table module A reference to the module invoking the function
--- @tparam string type A full path to a valid event type (e.g. 'core.module.events.some_event')
--- @tparam any content The content of the event, can be anything from a string to a table to whatever you please
