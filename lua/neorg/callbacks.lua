...
--- @tparam string event_name The full path to the event we want to listen on
--- @tparam function callback The function to call whenever our event gets triggered
--- @tparam function content_filter A filtering function to test if a certain event meets our expectations
...
--- @tparam table event An event as returned by neorg.events.create()
