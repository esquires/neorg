...
module.public = {
    ...
    --- @tparam string module_name The name of the module that owns the keybind. Make sure it's an absolute path.
    --- @tparam string name The name of the keybind. The module_name will be prepended to this string to form a unique name.
    ...
    --- @tparam string module_name The name of the module that owns the keybind. Make sure it's an absolute path.
    --- @tparam list names of strings A list of strings detailing names of the keybinds. The module_name will be prepended to each one to form a unique name.
    ...
    bind_all = function()
        ...
        payload = {
            ...
            --- @tparam string mode Same as the mode parameter for :h nvim_buf_set_keymap
            --- @tparam string key Same as the lhs parameter for :h nvim_buf_set_keymap
            --- @tparam string command Same as the rhs parameter for :h nvim_buf_set_keymap
            --- @tparam table opts Same as the opts parameter for :h nvim_buf_set_keymap
            ...
            --- @tparam string mode The neorg mode to bind the keys on
            --- @tparam table keys { <neovim_mode> = { { "<key>", "<name-of-keybind>" } } } A table of keybinds
            --- @tparam table opts The same parameters that should be passed into vim.api.nvim_set_keymap()'s opts parameter
