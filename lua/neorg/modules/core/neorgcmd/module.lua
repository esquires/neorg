...
--- @tparam nil _ Placeholder variable
--- @tparam string command Supplied by nvim itself; the full typed out command
...
module.public = {
    ...
    --- @tparam string module_name An absolute path to a loaded module with a module.config.public.neorg_commands table following a valid structure
    ...
    --- @tparam table functions A table that follows the module.config.public.neorg_commands structure
    ...
    --- @tparam string name The relative path of the module we want to load
    ...
    --- @tparam string[] The contents of <f-args> provided by nvim itself
    ...
    --- @tparam function callback The same function format as you would receive by being called by :command -completion=customlist,v:lua.callback Neorg
