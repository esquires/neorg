...
return function(module)
    return {
        public = {
            ...
            --- @tparam string name The name of the floating window
            --- @tparam string input_text The input text to prompt the user for input
            --- @tparam function callback A function that gets invoked whenever the user provides some text.
            --- @tparam table modifiers Special table to modify certain attributes of the floating window (like centering on the x or y axis)
            --- @tparam table config A config like you would pass into nvim_open_win()
