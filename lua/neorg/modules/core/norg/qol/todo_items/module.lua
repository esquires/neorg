...
module.public = {
    ...
    --- @tparam number recursion_level the index of the parent to change. The higher the number the more the code will traverse up the syntax tree.
    ...
    --- @tparam userdata todo_node the todo node to extract the data from
    ...
    --- @tparam userdata node the node to modify
    --- @tparam string todo_item_type one of "done", "pending" or "undone"
    --- @tparam string char the character to place within the square brackets of the todo item (one of "x", "*" or " ")
