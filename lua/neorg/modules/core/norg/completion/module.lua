...
--- @tparam table context The context provided by the integration engine
--- @tparam table prev The previous table of completions - used for descent
--- @tparam string saved The saved regex in the form of a string, used to concatenate children nodes with parent nodes' regexes
